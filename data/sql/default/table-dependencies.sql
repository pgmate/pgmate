WITH dependencies AS (
  ...
  WHERE con.contype = 'f'
    AND fk_table_ns.nspname = 'demo'
    AND fk_table.relname = 'invoice_lines'
  ...
  WHERE obj_namespace.nspname = 'demo'
    AND obj_class.relname = 'invoice_lines'
  ...
  WHERE vw_namespace.nspname = 'demo'
    AND vw.relname = 'invoice_lines'
